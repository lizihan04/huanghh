...
public class Recipe2 {
    ...
    public void stoneSword(){
        if(backpackArr[13].getOwnCount()>=2&&backpackArr[4].getOwnCount()>=5){
            backpackArr[13].setOwnCount(backpackArr[13].getOwnCount()-2);
            backpackArr[4].setOwnCount(backpackArr[4].getOwnCount()-5);
